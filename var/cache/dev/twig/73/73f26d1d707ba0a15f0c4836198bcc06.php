...
class __TwigTemplate_3e886d1021cfad88d7f9b40747f33bc5 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"content\">
    <h1>Espace administratif</h1>
    <ul>
        <li><a href=\"{{ path('admin_reservations') }}\">Réservations</a></li>
        <li><a href=\"{{ path('admin_biens') }}\">Gérer les biens</a></li>
        <li><a href=\"{{ path('admin_facturations') }}\">Facturations</a></li>
    </ul>
</div>
</div>
{% endblock %}
", "admin/index.html.twig", "/app/templates/admin/index.html.twig");
    }
}
